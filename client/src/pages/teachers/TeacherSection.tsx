  ...
  const renderViewCard = (t: any) => (
    <div className="bg-white p-4 rounded-2xl border border-school-border card-shadow text-center">
      <div className="flex flex-col items-center gap-2">
        {t.photoUrl ? (
          <img src={t.photoUrl} alt="" loading="lazy" decoding="async" width={56} height={56} className="w-14 h-14 rounded-full object-cover border-2 border-school-border shadow-sm" />
        ) : t.hasPhoto ? (
          <img src={`${API_URL}/teachers/${t.id}/photo/`} alt="" loading="lazy" decoding="async" width={56} height={56} className="w-14 h-14 rounded-full object-cover border-2 border-school-border shadow-sm" />
        ) : (
