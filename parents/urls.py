...
urlpatterns = [
    ...
    path('parents/payments/<uuid:student_id>/', views.StudentPaymentsView.as_view(), name='parent-student-payments'),
    ...
    path('parents/notifications/', views.ParentNotificationsView.as_view(), name='parent-notifications'),
    path('parents/family-siblings/', views.FamilySiblingsView.as_view(), name='parent-family-siblings'),
    path('parents/family-claim/', views.FamilyClaimView.as_view(), name='parent-family-claim'),
